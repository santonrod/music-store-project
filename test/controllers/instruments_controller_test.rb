...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { brand: @instrument.brand, category: @instrument.category, details: @instrument.details, owner_id: @instrument.owner_id, price: @instrument.price, year: @instrument.year }
    end
  ...
  test "should update instrument" do
    patch :update, id: @instrument, instrument: { brand: @instrument.brand, category: @instrument.category, details: @instrument.details, owner_id: @instrument.owner_id, price: @instrument.price, year: @instrument.year }
    assert_redirected_to instrument_path(assigns(:instrument))
  end
